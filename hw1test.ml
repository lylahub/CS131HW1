...
let subset_test1 = subset [] [1;4;2;3]
let subset_test2 = not (subset [1;5;7] [4;3])

(* Q2 *)
let equal_sets_test0 = not (equal_sets [1; 2] [1; 2; 3])
let equal_sets_test1 = equal_sets [] []
let equal_sets_test2 = equal_sets [-1; -3; -5] [-5; -1; -3]

(* Q3 *)
let my_set_union_test0 = equal_sets (set_union [] []) []
let my_set_union_test1 = equal_sets (set_union [1;1;2] [2;3;3]) [1;2;3]
let my_set_union_test2 = equal_sets (set_union [1;3;5] [2;4;5]) [1;2;3;4;5]

(* Q4 *)
let my_set_all_union_test0 = equal_sets (set_all_union []) []
let my_set_all_union_test1 = equal_sets (set_all_union [[7;8]; [8;9]; [10]]) [7;8;9;10]
let my_set_all_union_test2 = equal_sets (set_all_union [[1;2]; [1;2]; [1;2]]) [1;2]
